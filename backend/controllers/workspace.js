...
const getWorkspaceStats = async (req, res) => {
    try {
        ...
        const totalProjectsInProgress = projects.filter((project) => project.status === "In Progress").length;
        const totalProjectsCompleted = projects.filter((project) => project.status === "Completed").length;
        ...
        const projectStatusData = [
            { name: "Completed", value: 0, color: "#100981" },
            { name: "In Progress", value: 0, color: "#308276" },
