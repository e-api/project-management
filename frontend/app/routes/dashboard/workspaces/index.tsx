        ...
        <>
            <div className="space-y-8">
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    {workspaces.length === 0 && (
                        <NoDataFound title="No workspaces found" description="Create a new workspace to get started" buttonText="Create Workspace" buttonAction={() => setIsCreatingWorkspace(true)} />
                    )}
                </div>
            </div>
