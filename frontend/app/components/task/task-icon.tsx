...
import { Building2, CheckCircle, CheckCircle2, CheckSquare, Filter, FolderEdit, FolderPlus, LogIn, MessageSquare, Upload, UserMinus, UserPlus } from "lucide-react";
        ...
        case "updated_subtask":
            return (
                <div className="bg-blue-600/10 p-2 rounded-md">
                    <Filter className="h-5 w-5 text-blue-600 rounded-full" />
                </div>
            );
        case "completed_task":
            return (
