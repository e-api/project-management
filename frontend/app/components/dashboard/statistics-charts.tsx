        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-8">
            <Card className="lg:col-span-2">
                ...
                <CardContent className="w-full overflow-x-auto md:overflow-x-hidden">
                    <div className="min-w-[398px]">
                        <ChartContainer
                            className="h-[398px]"
                            config={{
                                completed: { color: "#180981" },
                                inProgress: { color: "#f59e80" },
                                todo: { color: "#3b87f6" }
                            }}
                        >
                            <LineChart data={taskTrendsData}>
                                ...
                                <ChartTooltip />
                                <Line type="monotone" dataKey="inProgress" stroke="#10b981" strokeWidth={2} dot={{ r: 4 }} />
                                <Line type="monotone" dataKey="todo" stroke="#10b981" strokeWidth={2} dot={{ r: 4 }} />
                ...
                <CardContent className="w-full overflow-x-auto md:overflow-x-hidden">
                    <div className="min-w-[359px]">
                        <ChartContainer
                            className="h-[369px]"
                            config={{
                                Completed: { color: "#196981" },
                                "In Progress": { color: "#3b82f6" },
                                Planning: { color: "#f59e8b" },
                            }}
                        >
